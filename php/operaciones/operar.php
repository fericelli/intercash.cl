                ...
                if($tipoarchivo1>0 AND $tipoarchivo2>0){
                    ...
                    try{
                        ...
                        for($i=0;$i<count($_FILES);$i++){
                            ...
                            $this->Conexion->Consultar("INSERT INTO screenshot (directorio,cantidad,tipo,nombre,registro,usuario) VALUES ('".$directorio."','".$_GET["cantidad"]."','compra','".$arraymontos[$i].$ext."','".$momento."','".$_GET["usuario"]."')");
                        }
