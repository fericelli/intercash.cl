<?php
	Class Informacion{
		...
		private function retorno(){
			...
			$cantidadcompradaUSDT =  floatval($this->Conexion->Recorrido($this->Conexion->Consultar("SELECT SUM(monto) FROM operaciones WHERE moneda='USDT' AND operacion='compra' AND tipo IS NULL"))[0]);
