    ...
    Class Datos{
		...
		private function retorno(){
            try{
				...
				$datos = [];
				$consultar = $this->Conexion->Consultar("SELECT * FROM prestamos LEFT JOIN paises ON paises.iso2=pais.pais WHERE momento LIKE '".$_POST["fecha"]."%'");
				/*while($prestamos = $this->Conexion->Recorrido($consultar)){
