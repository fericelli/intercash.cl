    ...
    Class MonedaOperaciones{
		...
		private function retorno(){
            ...
            if(isset($_POST["moneda"])){
                ...
                $consultapais =$this->Conexion->Consultar("SELECT DISTINCT monedacompra,nombremoneda,decimalesmoneda,iso2 FROM tasas LEFT JOIN paises ON iso_moneda=monedacompra");
            }
