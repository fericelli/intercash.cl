<?php
    ...
    Class MonedaOperaciones{
		...
		private function retorno(){
            ...
            $consultapais =$this->Conexion->Consultar("SELECT DISTINCT monedacompra,nombremoneda,decimalesmoneda,iso2 FROM tasas LEFT JOIN paises ON iso_moneda=monedacompra WHERE receptor IS NOT NULL");
