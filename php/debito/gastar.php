    ...
    Class Gastar{
		...
		private function retorno(){
            try{
                ...
                if($_GET["monedapago"]==$_GET["monedagasto"]){
                    ...
                    $this->Conexion->Consultar("INSERT INTO operaciones (moneda,monto,operacion,momento,usuario,operador,registro,tasa,monedaintercambio,paisintercambio,montointercambio,tipo) VALUES ('USDT','".$cantidad."','venta','".date("Y-m-d H:i:s")."','".$_GET["usuario"]."','".$_GET["usuario"]."','".$gastos."','".$tasa."','".$_GET["monedapago"]."','".$_GET["pais"]."','".$_GET["gastopais"]."','gastos')");
                    sleep(1);
                    $this->Conexion->Consultar("INSERT INTO operaciones (moneda,monto,operacion,momento,usuario,operador,registro,tasa,monedaintercambio,paisintercambio,montointercambio,tipo) VALUES ('USDT','0','compra','".date("Y-m-d H:i:s")."','".$_GET["usuario"]."','".$_GET["usuario"]."','".$gastos."','".$tasa."','".$_GET["monedapago"]."','".$_GET["pais"]."','".$_GET["gastopais"]."','gastos')");
                }else{
