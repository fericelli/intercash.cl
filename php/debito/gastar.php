		...
		private function retorno(){
            try{
                ...
                if($_GET["monedapago"]==$_GET["monedagasto"]){
                    ...
                    $this->Conexion->Consultar("INSERT INTO operaciones (moneda,monto,operacion,momento,usuario,operador,registro,tasa,monedaintercambio,paisintercambio,montointercambio,tipo,cantidadusdt) VALUES ('USDT','".$cantidad."','venta','".date("Y-m-d H:i:s")."','".$_GET["usuario"]."','".$_GET["usuario"]."','".$gastos."','".$tasa."','".$_GET["monedapago"]."','".$_GET["pais"]."','".$_GET["gastopais"]."','gastos','".$cantidad."')");
                    sleep(1);
                    $this->Conexion->Consultar("INSERT INTO operaciones (moneda,monto,operacion,momento,usuario,operador,registro,tasa,monedaintercambio,paisintercambio,montointercambio,tipo,cantidadusdt) VALUES ('USDT','0','compra','".date("Y-m-d H:i:s")."','".$_GET["usuario"]."','".$_GET["usuario"]."','".$gastos."','".$tasa."','".$_GET["monedapago"]."','".$_GET["pais"]."','".$_GET["gastopais"]."','gastos','0')");
                }else{
                    $this->Conexion->Consultar("INSERT INTO operaciones (moneda,monto,operacion,momento,usuario,operador,registro,tasa,monedaintercambio,paisintercambio,montointercambio,tipo,cantidadusdt) VALUES ('".$_GET["monedagasto"]."','".$_GET["cantidadgasto"]."','venta','".date("Y-m-d H:i:s")."','".$_GET["usuario"]."','".$_GET["usuario"]."','".$gastos."','".$tasa."','".$_GET["monedapago"]."','".$_GET["pais"]."','".$_GET["gastopais"]."','gastos','".$_GET["cantidadgasto"]."')");
                }
            }catch(Exception $e){
                return '"Error","error"';
            }
