                ...
                if(opcion=="creditos"){
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            html += '<input type="date">'; 
                            html += '<div id="creditos" style="height:35px; padding:0px 10px;margin:auto;cursor:pointer;border:1px solid #000;display:flex" ><i class="icono-bitcoin"></i><div>Créditos</div></div>'
                            html += '<div id="pagar" style="height:35px; padding:0px 10px;margin:auto;cursor:pointer;border:1px solid #000;display:flex" ><i class="icono-bitcoin"></i><div>Pagar</div></div>'
                              
                            html += '</div>';
                            html += "<div class='table-responsive'><h2>Créditos</h2><table class='table table-striped table-sm'><thead style='text-align:center'><tr><th scope='col'>Moneda</th><th scope='col'>Dinero</th><th scope='col'>Tipo</th><th scope='col'>Informaion</th><th></th></tr></thead><tbody>";
                            for(i=0;i<JSON.parse(data).length;i++){
                                html += "<tr><td>"+JSON.parse(data)[i][2]+"</td>";
                                html += "<td>"+JSON.parse(data)[i][3]+"</td>";
                                if(JSON.parse(data)[i][1]=="gastos"){
                            ...
                            html += '</tbody></table></div><center><img class="imagencargasolicitud" style="display:none;width:30px;height:30px" src="../imagenes/carga.gif"></center><script src="./../js/creditos.js"></script>';
