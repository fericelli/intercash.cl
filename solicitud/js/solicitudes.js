...
$(".enviar").on("click",function(){
        ...
        html += '<label class="margen">Monto pendiente <span class="pendiente">'+pendiente+'<span> '+monedadestino+'</label>';
        ...
        html += '<label class="margen">Seleccione una moneda</label>';
        html += '<div id="monedaintercambio"></div>';
